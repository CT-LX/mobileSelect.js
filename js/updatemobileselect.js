...
(function () {
  ...
  MobileSelect.prototype = {
    ...
    init: function (config) {
      ...
      //按钮监听
      _this.cancelBtn.addEventListener("click", _this.hide.bind(_this));

      _this.ensureBtn.addEventListener("click", _this.ensureBtnFun.bind(_this));

      _this.trigger.addEventListener("click", _this.show.bind(_this));
      _this.grayLayer.addEventListener("click", _this.hide.bind(_this));
    ...
    removeHandle: function () {
      this.mobileSelect.removeEventListener("click", this.hide);
      this.mobileSelect.removeEventListener("click", this.ensureBtnFun);
      this.mobileSelect.removeEventListener("click", this.show);

      if (this.isPC) {
        this.mobileSelect.removeEventListener("mousedown", this.dragClick);
        this.mobileSelect.removeEventListener("mousemove", this.dragClick);
        this.mobileSelect.removeEventListener("mouseup", this.dragClick);
      } else {
        //   移动端触发事件
        this.mobileSelect.removeEventListener("touchstart", this.touch);
        this.mobileSelect.removeEventListener("touchend", this.touch);
        this.mobileSelect.removeEventListener("touchmove", this.touch);
      }
    },
    // 删除节点
    deleteNode: function () {
      this.mobileSelect.parentElement.removeChild(this.mobileSelect);
    },
    ensureBtnFun: function () {
      var _this = this;
      _this.hide();
      if (!_this.liHeight) {
        _this.liHeight = _this.mobileSelect.querySelector("li").offsetHeight;
    ...
    addListenerWheel: function (theWheel, index) {
      ...
      theWheel.addEventListener(
        "touchstart",
        _this.touch.bind(_this, theWheel.firstChild, index),
        false
      );
      theWheel.addEventListener(
        "touchend",
      ...
      if (_this.isPC) {
        ...
        theWheel.addEventListener(
          "mousedown",
          _this.dragClick.bind(_this, theWheel.firstChild, index),
          false
        );
        theWheel.addEventListener(
          "mousemove",
    ...
    getInnerHtml: function (sliderIndex) {
      var _this = this;
      var lengthOfList = _this.slider[sliderIndex].getElementsByTagName("li")
        .length;
    ...
    touch: function (theSlider, index, event) {
      var _this = this;
    ...
    dragClick: function (theSlider, index, event) {
      var _this = this;
      event = event || window.event;
      switch (event.type) {
        case "mousedown":
